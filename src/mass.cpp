...
MassBuilder::MassBuilder(const float* m, const Dimension& dimension) : mass(0), cx(0), cy(0) {
    uint32_t k;
...
MassBuilder::MassBuilder() : mass(0), cx(0), cy(0) {}
...
Mass::Mass(float mass_, float cx_, float cy_) : mass(mass_), cx(cx_), cy(cy_) {}
