...
TEST(PlatecCreate, SameResultAsPlatec)
{
  ...
  CHECKF_EQ(1.785782814025879f,   heightmap[1000]);
  CHECKF_EQ(1.8174481391906738f,  heightmap[5000]);
  CHECKF_EQ(0.10000000149011612f, heightmap[50000]);
  CHECKF_EQ(0.10000000149011612f, heightmap[100000]);
  CHECKF_EQ(0.10000000149011612f, heightmap[150000]);
  CHECKF_EQ(1.7049407958984375f,  heightmap[200000]);
  CHECKF_EQ(0.10000000149011612f, heightmap[250000]);
...
TEST(PlatecGlobalGeneration, SameResultAsPlatec)
{
  ...
  CHECKF_EQ(0.1930341273546219f,  heightmap[1000]);
  CHECKF_EQ(0.14793574810028076f, heightmap[5000]);
  CHECKF_EQ(0.15966156125068665f, heightmap[50000]);
  CHECKF_EQ(2.9937195777893066f,  heightmap[100000]);
  CHECKF_EQ(0.1959685981273651f,  heightmap[150000]);
  CHECKF_EQ(0.18909034132957458f, heightmap[200000]);
  CHECKF_EQ(0.18724516034126282f, heightmap[250000]);
